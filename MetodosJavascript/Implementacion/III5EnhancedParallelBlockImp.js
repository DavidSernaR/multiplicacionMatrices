...
import { III5enhanced_parallel_block } from "../Algoritmos/III5EnhancedParallelBlock.js"; // Importa la función III5enhanced_parallel_block desde el archivo III5EnhancedParallelBlock.js
...
const NombreAlgoritmo = "III5EnhancedParallelBlock";
...
for (let i = 1; i <= 3; i++) { // Cambiado a iterar 3 veces, como en el código Python
    ...
    let matrizR = await III5enhanced_parallel_block(matrizA, matrizB, matrizResultado, matrizA.length/2);  // Ejecución del algoritmo con espera asincrónica
