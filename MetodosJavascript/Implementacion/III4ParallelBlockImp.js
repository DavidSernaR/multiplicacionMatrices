...
import { III4parallel_block } from "../Algoritmos/III4ParallelBlock.js"; // Importa la función III4parallel_block desde el archivo III4ParallelBlock.js
...
const NombreAlgoritmo = "III4ParallelBlock";
...
for (let i = 1; i <= 8; i++) { // Cambiado a iterar 8 veces, como en el código Python
    ...
    let matrizR = await III4parallel_block(matrizA, matrizB, matrizResultado, matrizA.length / 2); // Ejecución del algoritmo con espera asincrónica
