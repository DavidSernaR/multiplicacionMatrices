...
// Importación de funciones necesarias desde archivos externos
import { naiv_loop_unrolling_four } from "../Algoritmos/NaivLoopUnrollingFour.js"; // Importa la función naiv_loop_unrolling_four desde el archivo NaivLoopUnrollingFour.js
...
const NombreAlgoritmo = "NaivLoopUnrollingFour";
...
for (let i = 1; i <= 8; i++) { // Cambiado a iterar 8 veces, como en el código Python
    ...
    let matrizR = naiv_loop_unrolling_four(matrizA, matrizB, matrizResultado, matrizA.length, matrizA.length, matrizA.length); // Ejecución del algoritmo
