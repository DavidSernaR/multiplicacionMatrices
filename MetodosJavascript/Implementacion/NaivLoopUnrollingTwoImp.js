...
// Importación de la función naiv_loop_unrolling_two desde un archivo externo
import { naiv_loop_unrolling_two } from "../Algoritmos/NaivLoopUnrollingTwo.js";
...
const NombreAlgoritmo = "NaivLoopUnrollingTwo";
...
for (let i = 1; i <= 8; i++) { // Cambiado a iterar 8 veces, como en el código Python
    ...
    let matrizR = naiv_loop_unrolling_two(matrizA, matrizB, matrizResultado, matrizA.length, matrizA.length, matrizA.length); // Ejecución del algoritmo
