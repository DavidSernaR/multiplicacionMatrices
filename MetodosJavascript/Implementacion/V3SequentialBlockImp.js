...
// Importación de la función V3_sequential_block desde un archivo externo
import { V3_sequential_block } from "../Algoritmos/V3SequentialBlock.js";
...
const NombreAlgoritmo = "V3SequentialBlock";
...
for (let i = 1; i <= 8; i++) { // Cambiado a iterar 8 veces, como en el código Python
    ...
    let matrizR = V3_sequential_block(matrizA, matrizB, matrizResultado, matrizA.length/2); // Ejecución del algoritmo
