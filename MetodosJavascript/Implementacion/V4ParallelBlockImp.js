...
// Importación de la función V4_parallel_block desde un archivo externo
import { V4_parallel_block } from "../Algoritmos/V4ParallelBlock.js";
...
const NombreAlgoritmo = "V4ParallelBlock";
...
for (let i = 1; i <= 3; i++) { // Cambiado a iterar 3 veces, como en el código Python
    ...
    let matrizR = await V4_parallel_block(matrizA, matrizB, matrizResultado, matrizA.length/2); // Ejecución del algoritmo
