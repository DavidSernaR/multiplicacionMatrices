...
// Importación de la función winograd_scaled desde un archivo externo
import { winograd_scaled } from "../Algoritmos/WinogradScaled.js";
...
const NombreAlgoritmo = "WinogradScaled";
...
for (let i = 1; i <= 8; i++) { // Cambiado a iterar 8 veces, como en el código Python
    ...
    let matrizR = winograd_scaled(matrizA, matrizB, matrizResultado, matrizA.length, matrizB.length, matrizResultado.length); // Ejecución del algoritmo
