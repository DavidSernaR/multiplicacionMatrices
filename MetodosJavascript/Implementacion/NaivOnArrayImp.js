...
// Importación de la función naiv_on_array desde un archivo externo
import { naiv_on_array } from "../Algoritmos/NaivOnArray.js";
...
const NombreAlgoritmo = "NaivOnArray";
...
for (let i = 1; i <= 3; i++) { // Cambiado a iterar 3 veces, como en el código Python
    ...
    let matrizR = naiv_on_array(matrizA, matrizB, matrizResultado, matrizA.length, matrizA.length, matrizA.length); // Ejecución del algoritmo
