...
import { IV4_parallel_block } from "../Algoritmos/IV4ParallelBlock.js"; // Importa la función IV4_parallel_block desde el archivo IV4ParallelBlock.js
...
const NombreAlgoritmo = "IV4ParallelBlock";
...
for (let i = 1; i <= 3; i++) { // Cambiado a iterar 3 veces, como en el código Python
    ...
    let matrizR = await IV4_parallel_block(matrizA, matrizB, matrizResultado, matrizA.length/2); // Ejecución del algoritmo con espera asincrónica
