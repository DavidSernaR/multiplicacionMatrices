...
// Importación de la función winograd_original desde un archivo externo
import { winograd_original } from "../Algoritmos/WinogradOriginal.js";
...
for (let i = 1; i <= 3; i++) { // Cambiado a iterar 3 veces, como en el código Python
    ...
    let matrizR = winograd_original(matrizA, matrizB, matrizResultado, matrizA.length, matrizB.length, matrizResultado.length); // Ejecución del algoritmo
