...
// Importación de la función strassen_naiv desde un archivo externo
import { strassen_naiv } from "../Algoritmos/StrassenNaiv.js";
...
const NombreAlgoritmo = "StrassenNaiv";
...
for (let i = 1; i <= 8; i++) { // Cambiado a iterar 8 veces, como en el código Python
    ...
    let matrizR = strassen_naiv(matrizA, matrizB, matrizResultado, matrizA.length, matrizB.length, matrizResultado.length); // Ejecución del algoritmo
