...
import { IV5enhanced_parallel_block } from "../Algoritmos/IV5EnhancedParallelBlock.js"; // Importa la función IV5enhanced_parallel_block desde el archivo IV5EnhancedParallelBlock.js
...
const NombreAlgoritmo = "IV5EnhancedParallelBlock";
...
for (let i = 1; i <= 8; i++) { // Cambiado a iterar 8 veces, como en el código Python
    ...
    let matrizR = await IV5enhanced_parallel_block(matrizA, matrizB, matrizResultado, matrizA.length/2); // Ejecución del algoritmo con espera asincrónica
